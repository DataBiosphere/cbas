...
public class WomtoolValueTypeProcessingException extends Exception {
  ...
  public WomtoolValueTypeProcessingException(String message) {
    super(message);
  }

  public static class WomtoolValueTypeNotFoundException
      extends WomtoolValueTypeProcessingException {
