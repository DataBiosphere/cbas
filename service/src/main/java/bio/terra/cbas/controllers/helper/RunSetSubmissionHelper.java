...
public class RunSetSubmissionHelper {
  ...
  public void triggerWorkflowSubmit(
    ...
    WdsRecordResponseDetails wdsRecordResponses = fetchWdsRecords(wdsService, request);
  ...
  private WdsRecordResponseDetails fetchWdsRecords(WdsService wdsService, RunSetRequest request) {
