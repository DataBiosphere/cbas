...
class TestCromwellClient {
  ...
  void useConfiguredUrlIfAvailable() throws Exception {
    ...
    CromwellClient cromwellClient =
        new CromwellClient(
            cromwellServerConfiguration, credentialLoader, cromwellServerConfiguration.baseUri());
    ApiClient mockApiClient = cromwellClient.getReadApiClient(bearerToken.getToken());

    EngineApi engineApi =
        new CromwellClient(
                cromwellServerConfiguration,
                credentialLoader,
                cromwellServerConfiguration.baseUri())
  ...
  void lookupCromwellUrlWhenNecessary() {
    ...
    CromwellClient cromwellClient =
        new CromwellClient(
            cromwellServerConfiguration,
            credentialLoader,
            "https://my-cromwell-service:10101/cromwell");
