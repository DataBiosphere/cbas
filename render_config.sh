...
BATCHANALYSIS_VAULT_PATH="secret/dsde/terra/kernel/$ENV/$ENV/batchanalysis"
...
$VAULT_COMMAND -field=providers "BATCHANALYSIS_VAULT_PATH/providers" >"$SERVICE_OUTPUT_LOCATION/providers.yaml"
$VAULT_COMMAND -field=swagger-client-id "BATCHANALYSIS_VAULT_PATH/swagger-client-id" >"$SERVICE_OUTPUT_LOCATION/swagger-client-id"
